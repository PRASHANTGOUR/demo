...
<div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
    ...
    <div class="container-xxl">
        <div class="row justify-content-center">
            <form action="<?= url_to('StockMovementController::store');?>" method="POST">
                <?= csrf_field() ?>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control form-control-sm" name="movement_type" id="movement_type" required>
                        ...
                        <option value="in" <?= set_select('movement_type', 'in') ?>>In</option>
                        <option value="out" <?= set_select('movement_type', 'out') ?>>Out</option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control form-control-sm" name="quantity" id="quantity" value="<?= set_value('quantity') ?>" required>
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control form-control-sm" name="movement_date" id="movement_date" value="<?= set_value('movement_date') ?>" required>
